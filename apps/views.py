...
from apps.serializers import CategoryModelSerializer, CreateProductModelSerializer, ListProductModelSerializer, \
    ProductDocumentSerializer, ProductViewHistorySerializer
...
product_id = openapi.Parameter('product_id', in_=openapi.IN_QUERY, type=openapi.TYPE_INTEGER)

class ProductViewHistoryAPIView(ListCreateAPIView):
    ...
    def post(self, request):
        ...
        ProductViewHistory.objects.create(user=user, product_id=product_id)
